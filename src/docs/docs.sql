...
ALTER TABLE account_managers.accounts ADD location varchar(100) NOT NULL;
ALTER TABLE account_managers.accounts CHANGE location location varchar(100) NOT NULL AFTER account_name;
